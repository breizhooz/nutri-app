...
class BodyCompositionSnapshot(Base, SlugMixin, TimestampMixin):
    ...
    body_fat_percentage: Mapped[Decimal | None] = mapped_column(Numeric(4, 1), nullable=True)
    ...
    water_percentage: Mapped[Decimal | None] = mapped_column(Numeric(4, 1), nullable=True)