...
class TestTrackerRoutes:
    ...
    async def _create_profile(self, client: AsyncClient) -> None:
        ...
        await client.post(
            "/api/v1/profiles", json={"height_cm": 175.0, "weight_kg": 70.0}
        )
    ...
    async def test_add_composition_nominal(self, client: AsyncClient) -> None:
        ...
        resp = await client.post(
            "/api/v1/profiles/me/composition",
            json={
    ...
    async def test_list_composition_ordered_desc(self, client: AsyncClient) -> None:
        ...
        await client.post(
            "/api/v1/profiles/me/composition", json={"measured_at": "2026-04-01"}
        )
        await client.post(
            "/api/v1/profiles/me/composition", json={"measured_at": "2026-05-01"}
        )
    ...
    async def test_delete_composition_nominal(self, client: AsyncClient) -> None:
        ...
        assert (
            await client.delete(f"/api/v1/profiles/me/composition/{slug}")
        ).status_code == 204
    ...
    async def test_delete_composition_not_found(self, client: AsyncClient) -> None:
        ...
        assert (
            await client.delete("/api/v1/profiles/me/composition/ghost-slug")
        ).status_code == 404
    ...
    async def test_add_measurements_nominal(self, client: AsyncClient) -> None:
        ...
        resp = await client.post(
            "/api/v1/profiles/me/measurements",
            json={
                "measured_at": "2026-05-01",
                "waist_cm": 88.0,
                "hips_cm": 99.5,
    ...
    async def test_delete_measurements_nominal(self, client: AsyncClient) -> None:
        ...
        created = await client.post(
            "/api/v1/profiles/me/measurements", json={"measured_at": "2026-05-10"}
        )
        slug = created.json()["slug"]
        assert (
            await client.delete(f"/api/v1/profiles/me/measurements/{slug}")
        ).status_code == 204
