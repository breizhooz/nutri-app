...
class TestMedicalRoutes:
    ...
    async def test_add_injury_nominal(self, client: AsyncClient) -> None:
        ...
        resp = await client.post(
            ...
            json={
                "body_part": "Genou gauche",
                "injury_type": "Tendinite rotulienne",
            },
        )
    ...
    async def test_list_injuries_nominal(self, client: AsyncClient) -> None:
        ...
        await client.post(
            "/api/v1/profiles/me/injuries",
            json={"body_part": "Dos", "injury_type": "Hernie"},
        )
    ...
    async def test_delete_injury_nominal(self, client: AsyncClient) -> None:
        ...
        assert (
            await client.delete(f"/api/v1/profiles/me/injuries/{slug}")
        ).status_code == 204
    ...
    async def test_add_medication_nominal(self, client: AsyncClient) -> None:
        ...
        resp = await client.post(
            "/api/v1/profiles/me/medications",
            json={
                "medication_name": "Statine 20mg",
                "impacts_metabolism": True,
            },
        )
        assert resp.status_code == 201
    ...
    async def test_delete_allergy_not_found(self, client: AsyncClient) -> None:
        ...
        assert (
            await client.delete("/api/v1/profiles/me/allergies/ghost")
        ).status_code == 404
