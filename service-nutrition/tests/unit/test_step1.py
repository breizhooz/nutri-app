...
class TestBaseTargetsCalculator:
    ...
    def test_weight_loss_nominal(self, calc: BaseTargetsCalculator) -> None:
        ...
        t = calc.calculate("weight_loss", "standard", tdee_kcal=2500, bmr_kcal=1700, weight_kg=80)
    ...
    def test_muscle_gain_nominal(self, calc: BaseTargetsCalculator) -> None:
        ...
        t = calc.calculate("muscle_gain", "standard", tdee_kcal=2500, bmr_kcal=1700, weight_kg=80)
    ...
    def test_maintenance_and_recomposition(self, calc: BaseTargetsCalculator) -> None:
        assert calc.calculate("maintenance", "standard", 2200, 1600, 70).calories == 2200.0
        assert calc.calculate("body_recomposition", "standard", 2000, 1500, 70).calories == 1900.0
    ...
    def test_bmr_floor_triggered(self, calc: BaseTargetsCalculator) -> None:
        ...
        t = calc.calculate("weight_loss", "standard", tdee_kcal=2000, bmr_kcal=1900, weight_kg=80)
    ...
    def test_keto_override(self, calc: BaseTargetsCalculator) -> None:
        ...
        t = calc.calculate("maintenance", "keto", tdee_kcal=2000, bmr_kcal=1500, weight_kg=80)
        assert t.calories == 2000.0
    ...
    def test_sports_min_glucides_floor(self, calc: BaseTargetsCalculator) -> None:
        ...
        t = calc.calculate("sports_performance", "standard", tdee_kcal=2000, bmr_kcal=1500, weight_kg=80)
